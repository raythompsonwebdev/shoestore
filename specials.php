                ...
                <section id="results">
                    ...
                    <div class="product_boxes"><!--product boxes-->
                        ...
                        <figure class="product_box" >
                            ...
                            <figcaption class="product_boxdetails">
                               <img class="product_icon" src="images/page1_32.png" width="34" height="51" />
                    ...
                    <div class="product_boxes"><!--product boxes-->
                        ...
                        <figure class="product_box">
                            <img class="product_boximg"  src="images/kids-trainer.png" alt="kids-trainer" />
                            <figcaption class="product_boxdetails">
                                <img class="product_icon" src="images/shoppingcart.gif"  />
                                <span class="price">Kids Trainer</span>
                                <span class="price">&pound;80.00</span>
                            </figcaption>
                        </figure>
...
<script > window.jQuery || document.write('<script src="js/jquery-1.10.2.min.js">\x3C/script>')
</script>
